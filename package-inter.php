            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="desc-1">
                      ...
                      <p>Email Footer</p>
                      <img src="img/interzum/Email_footer-01.jpg" class="fn-img">
                      <div class="row">
                        <div class="col-12 boton">
                          <img src="img/personalizar.png">
                        </div>
                ...
                <div class="col-lg-4 revista">
                  <p>Pieza revista</p>
                  <div class="desc-1">
                    <img src="img/interzum/revista.jpg" class="fn-revista">
                    <div class="row">
                      <div class="col-10 boton">
                        <a href="https://koelnmesse.co/ferias/descargas/interzum/revista.zip" target="_blank"><img src="img/descargar.png"></a>
                      </div>
                      <div class="col-2"></div>
                    </div>
                  </div>
                ...
                <p>Logo</p>
                  <div class="desc-1">
                    <img src="img/interzum/logo.png" class="fn-logo">
                    <div class="row">
                      <div class="col-10 boton">
